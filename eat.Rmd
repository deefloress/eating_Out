...
```
In this numerical descriptions states and shows the frequency of eating out in white ethnicity as apposed to black and other.The graph shows that white ethnicity  as frequency of eating out is more than black and other ethnicing 
...
the fisher exact test for count data shows that the p value 0.001208
